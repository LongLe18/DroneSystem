...
def local_env_settings():
    ...
    settings.network_path = '/media/phuong/New Volume1/drone/DroneSystem/output/test/networks'    # Where tracking networks are stored.
    ...
    settings.result_plot_path = '/media/phuong/New Volume1/drone/DroneSystem/output/test/result_plots'
    settings.results_path = '/media/phuong/New Volume1/drone/DroneSystem/output/test/tracking_results'    # Where to store tracking results
    settings.save_dir = '/media/phuong/New Volume1/drone/DroneSystem/output'
    settings.segmentation_path = '/media/phuong/New Volume1/drone/DroneSystem/output/test/segmentation_results'
